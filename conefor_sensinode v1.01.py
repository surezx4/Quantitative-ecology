...
class MainWindow(QMainWindow):
    ...
    def create_input_area(self):
        ...
        # 修复：添加connections_group_layout的定义
        connections_group_layout = QVBoxLayout(connections_group)
        ...
        connections_group_layout.addLayout(connections_file_layout)
        connections_group_layout.addWidget(QLabel("连接类型 📦:"))
        connections_group_layout.addWidget(self.connection_type_combo)
        connections_group_layout.addWidget(QLabel("结构类型 🏗️:"))
        connections_group_layout.addLayout(structure_layout)
